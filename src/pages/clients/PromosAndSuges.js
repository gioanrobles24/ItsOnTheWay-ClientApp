...
import {
  ...
  TouchableHighlight,
  Image,
  Alert,Switch, ToastAndroid,
  BackHandler,
  SafeAreaView,
   TouchableOpacity
} from 'react-native';
import { Actions } from 'react-native-router-flux';
import { Icon,Avatar,Badge,withBadge,Input,Card    } from 'react-native-elements'
...
export default class PromoAndSugesClientView extends Component
 {
    ...
    _renderItem2({item,index}){
        return (
          <TouchableOpacity
              onPress={() => alert('Pressed!')}>
              <Card containerStyle={{flexDirection: 'row',width:210, height: 200,marginLeft:-20,marginTop:10}}
    ...
    return (
      <View style={styles.container}>
	        <View>
	          <Text style={styles.Title}  h1>Promociones</Text>
	        </View>
	         <SafeAreaView style={{flex: 1}}>
              ...
              <View>
	          <Text style={styles.Title2}  h1>Sugerencias</Text>
	        </View>
	         <SafeAreaView style={{flex: 1}}>
                    <View style={{ flex: 1, flexDirection:'row', justifyContent: 'center', marginTop:-30 }}>
                       <Carousel
